    ...
    static NpcDefinition lookup(int npcId) {
        ...
        switch (npcId) {
            ...
            case 2359:
                ...
                entityDef.actions[0] = "Talk-to";
                entityDef.actions[2] = "Trade";
                entityDef.name = "PvP Gear Supplier";
                entityDef.description = "Sells high-tier PvP equipment".getBytes();
                entityDef.widthScale = 80;
                entityDef.heightScale = 80;
                break;
            case 6773:
                entityDef.actions = new String[5];
                ...
                break;
            case 7481:
                entityDef.name = "RuneCartel Vote Agent";
                entityDef.actions = new String[5];
                entityDef.actions[0] = "Talk-to";
                entityDef.actions[2] = "Trade";
                break;
            ...
            case 1519:
                ...
                break;
            case 6533:
                entityDef.name = "RuneCartel Skillermen";
                break;
            case 1520:
            ...
            case 306:
                entityDef.name = "RuneCartel Guide";
                break;
            case 5366:
            ...
            case 6481:
                entityDef.name = "Mac";
                entityDef.description = "Only the most knowledgeable players of RuneCartel are worthy of such a cape.".getBytes();
