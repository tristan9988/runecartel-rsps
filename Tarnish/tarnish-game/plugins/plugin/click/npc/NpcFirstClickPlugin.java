...
//                factory.execute();
        ...
        /* PvP Gear Supplier */
            case 2359:
                player.dialogueFactory.sendNpcChat(2359, "Looking to gear up for a fight?", "Right-click me and hit Trade to browse", "my PvP equipment.");
                player.dialogueFactory.sendOption("Open Store", () -> {
                    Store.STORES.get("PvP Gear Store").open(player);
